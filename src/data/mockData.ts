...
export const MOCK_CONVERSATIONS: Conversation[] = [
  {
    id: 'c1',
    other_user: { id: MOCK_USERS[0].id, full_name: MOCK_USERS[0].name, avatar_url: `https://i.pravatar.cc/150?u=${MOCK_USERS[0].id}`, bio: MOCK_USERS[0].bio },
    last_message: '嘿，今晚有什麼安排嗎？ 👀',
    last_message_time: new Date(Date.now() - 2 * 60 * 1000).toISOString(),
    unread: 2,
    user: MOCK_USERS[0],
    lastMessage: '嘿，今晚有什麼安排嗎？ 👀',
    lastTime: '2 分鐘前',
  },
  {
    id: 'c2',
    other_user: { id: MOCK_USERS[1].id, full_name: MOCK_USERS[1].name, avatar_url: `https://i.pravatar.cc/150?u=${MOCK_USERS[1].id}`, bio: MOCK_USERS[1].bio },
    last_message: '你發的那張照片太🔥了',
    last_message_time: new Date(Date.now() - 60 * 60 * 1000).toISOString(),
    unread: 1,
    user: MOCK_USERS[1],
    lastMessage: '你發的那張照片太🔥了',
    lastTime: '1 小時前',
  },
  {
    id: 'c3',
    other_user: { id: MOCK_USERS[3].id, full_name: MOCK_USERS[3].name, avatar_url: `https://i.pravatar.cc/150?u=${MOCK_USERS[3].id}`, bio: MOCK_USERS[3].bio },
    last_message: '週日要去爬山嗎？',
  ...
  {
    id: 'c4',
    other_user: { id: MOCK_USERS[6].id, full_name: MOCK_USERS[6].name, avatar_url: `https://i.pravatar.cc/150?u=${MOCK_USERS[6].id}`, bio: MOCK_USERS[6].bio },
    last_message: 'こんにちは！很高興認識你 😊',
    last_message_time: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString(),
    unread: 0,
    user: MOCK_USERS[6],
    lastMessage: 'こんにちは！很高興認識你 😊',
    lastTime: '昨天',
  },
];
